...
helpers = [] 
  ...
  constructor(
        ...
        text:`Para cadastrar local, deve-se preencher os campos de nome, CEP, Número de endereço do local. A partir de um CEP válido, iremos achar o seu endereço.`,expanded:false,heightText:135,playing:false})
  }
